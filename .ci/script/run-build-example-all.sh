...
declare -a EXAMPLE_LIST=("examples/debug/debug-serial-at90can128-uart0"
                         ...
                         "examples/driver/ioexpander/MCP23017/driver-mcp23017-i2c-atmega328p-debug"
                         "examples/driver/lora/RFM9x/driver-rfm9x-spi-atmega1284p-debug-moteino-mega-usb"
                         "examples/driver/lora/RFM9x/driver-rfm9x-spi-atmega1284p-receiver-moteino-mega-usb"
                         "examples/driver/lora/RFM9x/driver-rfm9x-spi-atmega1284p-transmitter-moteino-mega-usb"
                         "examples/driver/lora/RFM9x/driver-rfm9x-spi-atmega2560-debug-dragino-lora-shield-v1.4"
                         ...
                         "examples/driver/sensor/AS5600/driver-as5600-i2c-atmega328p-debug"
                         "examples/driver/sensor/BMG160/driver-bmg160-i2c-atmega328p"
                         "examples/driver/sensor/BMG160/driver-bmg160-i2c-atmega328p-debug"
                         "examples/driver/sensor/INA220/driver-ina220-i2c-atmega328p"
                         "examples/driver/sensor/INA220/driver-ina220-i2c-atmega328p-debug"
                         "examples/driver/sensor/L3GD20/driver-l3gd20-i2c-atmega328p"
                         "examples/driver/sensor/L3GD20/driver-l3gd20-i2c-atmega328p-debug"
                         "examples/driver/sensor/LIS2DSH/driver-lis2dsh-i2c-atmega328p"
                         "examples/driver/sensor/LIS2DSH/driver-lis2dsh-i2c-atmega328p-debug"
                         "examples/driver/sensor/LIS3DSH/driver-lis3dsh-i2c-atmega328p"
                         "examples/driver/sensor/LIS3DSH/driver-lis3dsh-i2c-atmega328p-debug"
                         "examples/driver/sensor/LIS3MDL/driver-lis3mdl-i2c-atmega328p"
                         "examples/driver/sensor/LIS3MDL/driver-lis3mdl-i2c-atmega328p-debug"
