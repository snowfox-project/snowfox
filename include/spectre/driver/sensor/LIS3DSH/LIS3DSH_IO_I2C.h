...
#ifndef INCLUDE_SPECTRE_DRIVER_SENSOR_LIS3DSH_LIS3DSH_IO_I2C_H_
#define INCLUDE_SPECTRE_DRIVER_SENSOR_LIS3DSH_LIS3DSH_IO_I2C_H_
...
class LIS3DSH_IO_I2C : public LIS3DSH_IO_Interface
{

public:

           LIS3DSH_IO_I2C(uint8_t const i2c_address, hal::interface::I2CMaster & i2c_master);
  virtual ~LIS3DSH_IO_I2C();
...
#endif /* INCLUDE_SPECTRE_DRIVER_SENSOR_LIS3DSH_LIS3DSH_IO_I2C_H_ */
