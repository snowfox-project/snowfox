...
#ifndef INCLUDE_SPECTRE_HAL_AVR_ATXXXX_DELAYSERVICE_H_
#define INCLUDE_SPECTRE_HAL_AVR_ATXXXX_DELAYSERVICE_H_
...
#endif /* INCLUDE_SPECTRE_HAL_AVR_ATXXXX_DELAYSERVICE_H_ */
