...
#ifndef INCLUDE_SPECTRE_COMSTACK_CANOPEN_NODEGUARDFRAMEHANDLER_H_
#define INCLUDE_SPECTRE_COMSTACK_CANOPEN_NODEGUARDFRAMEHANDLER_H_
...
#endif /* INCLUDE_SPECTRE_COMSTACK_CANOPEN_NODEGUARDFRAMEHANDLER_H_ */
