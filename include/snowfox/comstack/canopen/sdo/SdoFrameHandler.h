...
#ifndef INCLUDE_SNOWFOX_COMSTACK_CANOPEN_SDOFRAMEHANDLER_H_
#define INCLUDE_SNOWFOX_COMSTACK_CANOPEN_SDOFRAMEHANDLER_H_
...
class SdoFrameHandler : public interface::FrameHandler
{
