...
#ifndef INCLUDE_SNOWFOX_COMSTACK_CANOPEN_PDOFRAMEHANDLER_H_
#define INCLUDE_SNOWFOX_COMSTACK_CANOPEN_PDOFRAMEHANDLER_H_
...
#endif /* INCLUDE_SNOWFOX_COMSTACK_CANOPEN_PDOFRAMEHANDLER_H_ */
