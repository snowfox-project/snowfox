...
#ifndef INCLUDE_SNOWFOX_DRIVER_SENSOR_LIS3DSH_LIS3DSH_IO_I2C_H_
#define INCLUDE_SNOWFOX_DRIVER_SENSOR_LIS3DSH_LIS3DSH_IO_I2C_H_
...
class LIS3DSH_IoI2c final : public interface::LIS3DSH_Io
{

public:

           LIS3DSH_IoI2c(uint8_t const i2c_address, hal::interface::I2cMaster & i2c_master);
  virtual ~LIS3DSH_IoI2c();
...
#endif /* INCLUDE_SNOWFOX_DRIVER_SENSOR_LIS3DSH_LIS3DSH_IO_I2C_H_ */
