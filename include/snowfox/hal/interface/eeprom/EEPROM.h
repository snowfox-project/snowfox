...
#ifndef INCLUDE_SNOWFOX_HAL_INTERFACE_EEPROM_EEPROM_H_
#define INCLUDE_SNOWFOX_HAL_INTERFACE_EEPROM_EEPROM_H_
...
#endif /* INCLUDE_SNOWFOX_HAL_INTERFACE_EEPROM_EEPROM_H_ */
