...
#ifndef INCLUDE_SNOWFOX_HAL_AVR_ATXXXX_DIGITALINOUTPORT_H_
#define INCLUDE_SNOWFOX_HAL_AVR_ATXXXX_DIGITALINOUTPORT_H_
...
#endif /* INCLUDE_SNOWFOX_HAL_AVR_ATXXXX_DIGITALINOUTPORT_H_ */
