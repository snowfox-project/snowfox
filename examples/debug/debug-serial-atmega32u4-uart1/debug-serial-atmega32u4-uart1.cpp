...
int main()
{
  ...
  ATMEGA32U4::InterruptController int_ctrl(&EIMSK, &PCICR); /*, &WDTCSR, &TIMSK2, &TIMSK1, &TIMSK0, &SPCR, &UCSR0B, &ADCSRA, &EECR, &ACSR, &TWCR, &SPMCSR); */
  ...
  {
    debug_serial.print("( %08X ) Hello ATMEGA32U4\r\n", cnt);
  }
