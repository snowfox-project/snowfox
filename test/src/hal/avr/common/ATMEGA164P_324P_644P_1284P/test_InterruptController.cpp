...
namespace snowfox::hal::ATMEGA164P_324P_644P_1284P::test
{
...
SCENARIO("ATMEGA164P_324P_644P_1284P::InterruptController - interrupts are enabled via 'enableInterrupt' and disabled via 'disableInterrupt'", "[ATMEGA164P_324P_644P_1284P::InterruptController]")
{
  ...
  vireg::Vireg8 PCMSK1 = vregmap.get<vireg::Vireg8>("PCMSK1");
  vireg::Vireg8 PCMSK2 = vregmap.get<vireg::Vireg8>("PCMSK2");
  vireg::Vireg8 PCMSK3 = vregmap.get<vireg::Vireg8>("PCMSK3");
...
} /* snowfox::hal::ATMEGA164P_324P_644P_1284P::test */
