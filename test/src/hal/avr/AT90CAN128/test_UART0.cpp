...
static uint32_t const F_CPU_Hz = 16000000;

/**************************************************************************************
 * TEST CODE
 **************************************************************************************/

SCENARIO("AT90CAN128::UART0 - TODO", "[AT90CAN128::UART0]")
{
  ...
  AT90CAN128::UART0               uart0   (UDR0(), UCSR0A(), UCSR0B(), UCSR0C(), UBRR0(), int_ctrl, F_CPU_Hz);
