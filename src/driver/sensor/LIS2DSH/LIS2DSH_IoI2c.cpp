...
bool LIS2DSH_IoI2c::readRegister(interface::Register const reg, uint8_t * data, uint16_t const num_bytes)
{
...
bool LIS2DSH_IoI2c::readRegister(interface::Register const reg, uint8_t * data)
{
...
bool LIS2DSH_IoI2c::writeRegister(interface::Register const reg, uint8_t const * data, uint16_t const num_bytes)
{
  uint8_t const reg_addr = (0x80 | static_cast<uint8_t>(reg));
...
bool LIS2DSH_IoI2c::writeRegister(interface::Register const reg, uint8_t const data)
{
  uint8_t const reg_addr = static_cast<uint8_t>(reg);
