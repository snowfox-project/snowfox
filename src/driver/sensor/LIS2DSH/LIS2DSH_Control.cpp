...
void LIS2DSH_Control::debug_dumpAllRegs(debug::interface::Debug & debug_interface, hal::interface::Flash & flash)
{
  debug_dumpSingleReg(debug_interface, flash, STATUS_REG_AUX , interface::Register::STATUS_REG_AUX );

  debug_dumpSingleReg(debug_interface, flash, OUT_TEMP_L     , interface::Register::OUT_TEMP_L     );
  debug_dumpSingleReg(debug_interface, flash, OUT_TEMP_H     , interface::Register::OUT_TEMP_H     );

  debug_dumpSingleReg(debug_interface, flash, INT_COUNTER_REG, interface::Register::INT_COUNTER_REG);

  debug_dumpSingleReg(debug_interface, flash, WHO_AM_I       , interface::Register::WHO_AM_I       );

  debug_dumpSingleReg(debug_interface, flash, TEMP_CFG_REG   , interface::Register::TEMP_CFG_REG   );
  ...
  debug_dumpSingleReg(debug_interface, flash, CTRL_REG6      , interface::Register::CTRL_REG6      );
  ...
  debug_dumpSingleReg(debug_interface, flash, INT1_SOURCE    , interface::Register::INT1_SOURCE    );
  debug_dumpSingleReg(debug_interface, flash, INT1_THS       , interface::Register::INT1_THS       );
  debug_dumpSingleReg(debug_interface, flash, INT1_DURATION  , interface::Register::INT1_DURATION  );

  debug_dumpSingleReg(debug_interface, flash, INT2_CFG       , interface::Register::INT2_CFG       );
  debug_dumpSingleReg(debug_interface, flash, INT2_SOURCE    , interface::Register::INT2_SOURCE    );
  debug_dumpSingleReg(debug_interface, flash, INT2_THS       , interface::Register::INT2_THS       );
  debug_dumpSingleReg(debug_interface, flash, INT2_DURATION  , interface::Register::INT2_DURATION  );

  debug_dumpSingleReg(debug_interface, flash, CLICK_CFG      , interface::Register::CLICK_CFG      );
  debug_dumpSingleReg(debug_interface, flash, CLICK_SRC      , interface::Register::CLICK_SRC      );
  debug_dumpSingleReg(debug_interface, flash, CLICK_THS      , interface::Register::CLICK_THS      );

  debug_dumpSingleReg(debug_interface, flash, TIME_LIMIT     , interface::Register::TIME_LIMIT     );
  debug_dumpSingleReg(debug_interface, flash, TIME_LATENCY   , interface::Register::TIME_LATENCY   );
  debug_dumpSingleReg(debug_interface, flash, TIME_WINDOW    , interface::Register::TIME_WINDOW    );

  debug_dumpSingleReg(debug_interface, flash, ACT_THS        , interface::Register::ACT_THS        );
  debug_dumpSingleReg(debug_interface, flash, ACT_DUR        , interface::Register::ACT_DUR        );
}
...
void LIS2DSH_Control::debug_dumpSingleReg(debug::interface::Debug & debug_interface, hal::interface::Flash & flash, char const * msg, interface::Register const reg)
{
  char    msg_ram[32];
