...
void LIS3DSH_Control::debug_dumpAllRegs(debug::interface::Debug & debug_interface)
{
  debug_dumpSingleReg(debug_interface, "INFO_1 =      ", interface::Register::INFO_1    );
  debug_dumpSingleReg(debug_interface, "INFO_2 =      ", interface::Register::INFO_2    );
  ...
  debug_dumpSingleReg(debug_interface, "CTRL_REG_6 =  ", interface::Register::CTRL_REG_6);

  debug_dumpSingleReg(debug_interface, "STATUS =      ", interface::Register::STATUS    );

  debug_dumpSingleReg(debug_interface, "OUT_T =       ", interface::Register::OUT_T     );

  debug_dumpSingleReg(debug_interface, "OFF_X =       ", interface::Register::OFF_X     );
  debug_dumpSingleReg(debug_interface, "OFF_Y =       ", interface::Register::OFF_Y     );
  debug_dumpSingleReg(debug_interface, "OFF_Z =       ", interface::Register::OFF_Z     );
  debug_dumpSingleReg(debug_interface, "CS_X =        ", interface::Register::CS_X      );
  debug_dumpSingleReg(debug_interface, "CS_Y =        ", interface::Register::CS_Y      );
  debug_dumpSingleReg(debug_interface, "CS_Z =        ", interface::Register::CS_Z      );
  ...
  debug_dumpSingleReg(debug_interface, "FIFO_CTRL =   ", interface::Register::FIFO_CTRL );
  debug_dumpSingleReg(debug_interface, "FIFO_SRC =    ", interface::Register::FIFO_SRC  );
}
...
void LIS3DSH_Control::debug_dumpSingleReg(debug::interface::Debug & debug_interface, char const * msg, interface::Register const reg)
{
