...
void LSM6DSM_IoSpi::readRegister(interface::Register const reg, uint8_t * data)
{
...
void LSM6DSM_IoSpi::readRegister(interface::Register const reg, uint8_t * data, uint16_t const num_bytes)
{
  uint8_t const reg_addr = (0x80 | static_cast<uint8_t>(reg));
...
void LSM6DSM_IoSpi::writeRegister(interface::Register const reg, uint8_t const data)
{
...
void LSM6DSM_IoSpi::writeRegister(interface::Register const reg, uint8_t const * data, uint16_t const num_bytes)
{
  uint8_t const reg_addr = static_cast<uint8_t>(reg);
