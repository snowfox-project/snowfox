...
#elif defined(MCU_TYPE_at90can32)
  static uint8_t const INT_NUM = AT90CAN32_64_128::toIntNum           (AT90CAN32::Interrupt::EXTERNAL_INT2  );
#elif defined(MCU_TYPE_at90can64)
  static uint8_t const INT_NUM = AT90CAN32_64_128::toIntNum           (AT90CAN64::Interrupt::EXTERNAL_INT2  );
#elif defined(MCU_TYPE_at90can128)
  static uint8_t const INT_NUM = AT90CAN32_64_128::toIntNum           (AT90CAN128::Interrupt::EXTERNAL_INT2 );
#elif defined(MCU_TYPE_atmega164p)
  static uint8_t const INT_NUM = ATMEGA164P_324P_644P_1284P::toIntNum (ATMEGA164P::Interrupt::EXTERNAL_INT2 );
#elif defined(MCU_TYPE_atmega324p)
  static uint8_t const INT_NUM = ATMEGA164P_324P_644P_1284P::toIntNum (ATMEGA324P::Interrupt::EXTERNAL_INT2 );
#elif defined(MCU_TYPE_atmega644p)
  static uint8_t const INT_NUM = ATMEGA164P_324P_644P_1284P::toIntNum (ATMEGA644P::Interrupt::EXTERNAL_INT2 );
#elif defined(MCU_TYPE_atmega1284p)
  static uint8_t const INT_NUM = ATMEGA164P_324P_644P_1284P::toIntNum (ATMEGA1284P::Interrupt::EXTERNAL_INT2);
#elif defined(MCU_TYPE_atmega640)
  static uint8_t const INT_NUM = ATMEGA640_1280_2560::toIntNum        (ATMEGA640::Interrupt::EXTERNAL_INT2  );
#elif defined(MCU_TYPE_atmega1280)
  static uint8_t const INT_NUM = ATMEGA640_1280_2560::toIntNum        (ATMEGA1280::Interrupt::EXTERNAL_INT2 );
#elif defined(MCU_TYPE_atmega2560)
  static uint8_t const INT_NUM = ATMEGA640_1280_2560::toIntNum        (ATMEGA2560::Interrupt::EXTERNAL_INT2 );
#else
...
EINT2::EINT2(volatile uint8_t * eicra, interface::InterruptControl & int_ctrl)
: _EICRA                      (eicra   ),
  _int_ctrl                   (int_ctrl),
