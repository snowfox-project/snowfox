...
#if   defined(MCU_TYPE_atmega328p)
  static uint8_t const INT_NUM = ATMEGA328P::toIntNum(ATMEGA328P::Interrupt::EXTERNAL_INT2);
#elif defined(MCU_TYPE_at90can32)
...
#elif defined(MCU_TYPE_atmega2560)
  static uint8_t const INT_NUM = ATMEGA640_1280_2560::toIntNum(ATMEG2560::Interrupt::EXTERNAL_INT2 );
#else
