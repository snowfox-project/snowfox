...
#elif defined(MCU_TYPE_at90can32)
  static uint8_t const INT_NUM = AT90CAN32_64_128::toIntNum           (AT90CAN32::Interrupt::EXTERNAL_INT7 );
#elif defined(MCU_TYPE_at90can64)
  static uint8_t const INT_NUM = AT90CAN32_64_128::toIntNum           (AT90CAN64::Interrupt::EXTERNAL_INT7 );
#elif defined(MCU_TYPE_at90can128)
  static uint8_t const INT_NUM = AT90CAN32_64_128::toIntNum           (AT90CAN128::Interrupt::EXTERNAL_INT7);
#elif defined(MCU_TYPE_atmega164p)
...
#elif defined(MCU_TYPE_atmega640)
  static uint8_t const INT_NUM = ATMEGA640_1280_2560::toIntNum        (ATMEGA640::Interrupt::EXTERNAL_INT7 );
#elif defined(MCU_TYPE_atmega1280)
  static uint8_t const INT_NUM = ATMEGA640_1280_2560::toIntNum        (ATMEGA1280::Interrupt::EXTERNAL_INT7);
#elif defined(MCU_TYPE_atmega2560)
  static uint8_t const INT_NUM = ATMEGA640_1280_2560::toIntNum        (ATMEGA2560::Interrupt::EXTERNAL_INT7);
#else
...
EINT7::EINT7(volatile uint8_t * eicrb, interface::InterruptControl & int_ctrl)
: _EICRB                      (eicrb   ),
  _int_ctrl                   (int_ctrl),
