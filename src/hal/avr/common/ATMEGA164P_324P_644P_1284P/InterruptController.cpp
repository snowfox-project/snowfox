...
void InterruptController::disableInterrupt(uint8_t const int_num)
{
  ...
  case toIntNum(Interrupt::PIN_CHANGE_INT24               ): {                                   util::clrBit(_PCMSK3, PCINT24_bp); } break;
  case toIntNum(Interrupt::PIN_CHANGE_INT25               ): {                                   util::clrBit(_PCMSK3, PCINT25_bp); } break;
  case toIntNum(Interrupt::PIN_CHANGE_INT26               ): {                                   util::clrBit(_PCMSK3, PCINT26_bp); } break;
  case toIntNum(Interrupt::PIN_CHANGE_INT27               ): {                                   util::clrBit(_PCMSK3, PCINT27_bp); } break;
  case toIntNum(Interrupt::PIN_CHANGE_INT28               ): {                                   util::clrBit(_PCMSK3, PCINT28_bp); } break;
  case toIntNum(Interrupt::PIN_CHANGE_INT29               ): {                                   util::clrBit(_PCMSK3, PCINT29_bp); } break;
  case toIntNum(Interrupt::PIN_CHANGE_INT30               ): {                                   util::clrBit(_PCMSK3, PCINT30_bp); } break;
  case toIntNum(Interrupt::PIN_CHANGE_INT31               ): {                                   util::clrBit(_PCMSK3, PCINT31_bp); } break;
