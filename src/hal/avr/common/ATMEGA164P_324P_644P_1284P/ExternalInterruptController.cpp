...
void ExternalInterruptController::enable(uint8_t const ext_int_num)
{
  ...
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT24): { _int_ctrl.enableInterrupt(toIntNum(Interrupt::PIN_CHANGE_INT3)); *_PCMSK3 |= PCINT24_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT25): { _int_ctrl.enableInterrupt(toIntNum(Interrupt::PIN_CHANGE_INT3)); *_PCMSK3 |= PCINT25_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT26): { _int_ctrl.enableInterrupt(toIntNum(Interrupt::PIN_CHANGE_INT3)); *_PCMSK3 |= PCINT26_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT27): { _int_ctrl.enableInterrupt(toIntNum(Interrupt::PIN_CHANGE_INT3)); *_PCMSK3 |= PCINT27_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT28): { _int_ctrl.enableInterrupt(toIntNum(Interrupt::PIN_CHANGE_INT3)); *_PCMSK3 |= PCINT28_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT29): { _int_ctrl.enableInterrupt(toIntNum(Interrupt::PIN_CHANGE_INT3)); *_PCMSK3 |= PCINT29_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT30): { _int_ctrl.enableInterrupt(toIntNum(Interrupt::PIN_CHANGE_INT3)); *_PCMSK3 |= PCINT30_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT31): { _int_ctrl.enableInterrupt(toIntNum(Interrupt::PIN_CHANGE_INT3)); *_PCMSK3 |= PCINT31_bm; } break;
  }
}
...
void ExternalInterruptController::disable(uint8_t const ext_int_num)
{
  ...
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT24): {                                                                  *_PCMSK3 &= ~PCINT24_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT25): {                                                                  *_PCMSK3 &= ~PCINT25_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT26): {                                                                  *_PCMSK3 &= ~PCINT26_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT27): {                                                                  *_PCMSK3 &= ~PCINT27_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT28): {                                                                  *_PCMSK3 &= ~PCINT28_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT29): {                                                                  *_PCMSK3 &= ~PCINT29_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT30): {                                                                  *_PCMSK3 &= ~PCINT30_bm; } break;
  case toExtIntNum(ExternalInterrupt::PIN_CHANGE_INT31): {                                                                  *_PCMSK3 &= ~PCINT31_bm; } break;
  }
}
