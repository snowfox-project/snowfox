...
#include <spectre/blox/hal/avr/common/ATMEGA640_1280_2560/SpiMaster.h>
...
{
  int_ctrl.registerInterruptCallback(hal::ATMEGA640_1280_2560::toIntNum(hal::ATMEGA640_1280_2560::Interrupt::SPI_SERIAL_TRANSFER_COMPLETE), &_spi_master_on_serial_transfer_complete_callback_adapter);
  int_ctrl.enableInterrupt          (hal::ATMEGA640_1280_2560::toIntNum(hal::ATMEGA640_1280_2560::Interrupt::SPI_SERIAL_TRANSFER_COMPLETE));
}
