...
if(${MCU_ARCH} STREQUAL "avr" OR ${MCU_ARCH} STREQUAL "host")
  ...
  set(SPECTRE_LIBRARY_HAL_AVR_ATMEGA16U4_32U4_SRCS
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATMEGA16U4_32U4/ExternalInterruptController.cpp
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATMEGA16U4_32U4/InterruptController.cpp
  ...
  set(SPECTRE_LIBRARY_HAL_AVR_ATMEGA3209_4809_SRCS
    ...
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATMEGA3209_4809/TIMERA0.cpp
  ...
  set(SPECTRE_LIBRARY_HAL_AVR_ATxxxx_SRCS
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATxxxx/util/ExternalInterruptUtil.cpp
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATxxxx/util/UartUtil.cpp
    ...
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATxxxx/I2cMaster_onI2cTransferCompleteCallback.cpp
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATxxxx/I2cMaster.cpp       
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATxxxx/I2cMasterLowLevel.cpp
    ${SPECTRE_LIBRARY_HAL_AVR_PATH}/common/ATxxxx/SpiMaster_onSerialTransferCompleteCallback.cpp
  ...
  set(SPECTRE_LIBRARY_HAL_AVR_ATMEGA3209_SRCS
    ${SPECTRE_LIBRARY_HAL_AVR_ATMEGA3209_4809_SRCS}
  )
  
  if(${MCU_TYPE} STREQUAL "atmega3209" OR {MCU_TYPE} STREQUAL "host")
    set(SPECTRE_LIBRARY_HAL_SRCS ${SPECTRE_LIBRARY_HAL_SRCS} ${SPECTRE_LIBRARY_HAL_AVR_ATMEGA3209_SRCS})
  endif()
  ...
  set(SPECTRE_LIBRARY_HAL_AVR_ATMEGA4809_SRCS
    ${SPECTRE_LIBRARY_HAL_AVR_ATMEGA3209_4809_SRCS}
  )
  
  if(${MCU_TYPE} STREQUAL "atmega4809" OR {MCU_TYPE} STREQUAL "host")
    set(SPECTRE_LIBRARY_HAL_SRCS ${SPECTRE_LIBRARY_HAL_SRCS} ${SPECTRE_LIBRARY_HAL_AVR_ATMEGA4809_SRCS})
  endif()
