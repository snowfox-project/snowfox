...
if(${MCU_ARCH} STREQUAL "riscv64" OR ${MCU_ARCH} STREQUAL "host")
  ...
  set(SNOWFOX_LIBRARY_HAL_RISCV64_FE310_SRCS
    ...
    ${SNOWFOX_LIBRARY_HAL_RISCV_PATH}/FE310/I2cMaster.cpp
    ${SNOWFOX_LIBRARY_HAL_RISCV_PATH}/FE310/I2cMasterBase.cpp
    ${SNOWFOX_LIBRARY_HAL_RISCV_PATH}/FE310/I2cMasterLowLevel.cpp
