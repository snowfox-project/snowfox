...
if(${DRIVER_CAN_MCP2515} STREQUAL "yes")
  set(DRIVER_CAN_MCP2515_SRCS
    ${DRIVER_CAN_SRC_PATH}/MCP2515/MCP2515_Callback.cpp
...
if(${DRIVER_LORA_RFM9x} STREQUAL "yes")
  set(DRIVER_LORA_RFM9x_SRCS
    ${DRIVER_LORA_SRC_PATH}/RFM9x/packet_mode/RFM9x_Dio0EventCallback.cpp
    ${DRIVER_LORA_SRC_PATH}/RFM9x/packet_mode/RFM9x_onCadDoneCallback.cpp
