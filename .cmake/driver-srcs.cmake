...
if(${DRIVER_CAN_MCP2515} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_CAN_SRCS})
endif()
...
if(${DRIVER_GLCD_RA6963} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_GLCD_RA6963_SRCS})
endif()
...
if(${DRIVER_HAPTIC_DRV2605} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_HAPTIC_DRV2605_SRCS})
endif()
...
if(${DRIVER_IOEXPANDER_PCA9547} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_IOEXPANDER_PCA9547_SRCS})
endif()
...
if(${DRIVER_LORA_RFM9x} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_LORA_RFM9x_SRCS})
endif()
...
if(${DRIVER_MEMORY_PCF8570} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_MEMORY_PCF8570_SRCS})
endif()
...
if(${DRIVER_SENSOR_LIS3MDL} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_SENSOR_LIS3MDL_SRCS})
endif()
...
if(${DRIVER_SERIAL} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_SERIAL_SRCS})
endif()
...
if(${DRIVER_STEPPER_TMC26x} STREQUAL "yes")
  ...
  set(SPECTRE_LIBRARY_DRIVER_SRCS ${SPECTRE_LIBRARY_DRIVER_SRCS} ${DRIVER_STEPPER_TMC26x_SRCS})
endif()
